...
import { Player, PlayerMapping } from "./interfaces.js";
import { getKeyedPlayerMappings } from "./Utils.js";

export const NOTE_MARGIN = 1.5;

export default class PlayerPartitionProcessor {
  private clock: number = 0;
  private notesForPlayerAtTime: Record<Player, Record<number, ParsedNote[]>> =
  ...
  private currentBeatType: number = 0;
